...
import Canada from '../../asset/images/canada.png';
import India from '../../asset/images/india.png';
import Singapor from '../../asset/images/singapor.png';
import Pakistan from '../../asset/images/pakistan.png'
                ...
                <div>
                    ...
                    <h2 className="text-center">Countries We Offer</h2>
                        ...
                        <Slider {...settings}>
                            ...
                            <div>
                            <img src={Dubai} alt="dubai Flag" style={{ width: '320px', height: '160px' }} />
                            </div>
                            <div>
                            <img src={Canada} alt="canada Flag" style={{ width: '320px', height: '160px' }} />
                            </div>
                            <div>
                            <img src={India} alt="inida Flag" style={{ width: '320px', height: '160px' }} />
                            </div>
                            <div>
                            <img src={Singapor} alt="singapor flag" style={{width: '320px', height: '160px'}} />
                            </div>
                            <div>
                            <img src={Pakistan} alt="pakistan flag" style={{width: '320px', height: '160px'}} />
                            </div>
                            <div>
                            <img src={USA} alt="USA Flag" style={{ width: '320px', height: '160px' }} />
                            </div>
